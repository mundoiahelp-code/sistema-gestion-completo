...
export default function NuevoNegocioPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Generar link de activación con idioma
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => {
                    // Si cambia a inglés y el plan es PRO, cambiar a basic
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="en">🇺🇸 English (Basic)</SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="free">
                      {formData.locale === 'en' ? 'Free Trial (7 days)' : 'Prueba Gratuita (14 días)'}
                    </SelectItem>
                    <SelectItem value="basic">
                      {formData.locale === 'en' ? 'Basic' : 'Básico'}
                    </SelectItem>
                    {formData.locale === 'es' && (
                ...
                {formData.locale === 'en' && (
                  <p className="text-xs text-amber-600 dark:text-amber-500">
                    ⚠️ Professional plan only available in Spanish
                  </p>
                )}
              </div>
