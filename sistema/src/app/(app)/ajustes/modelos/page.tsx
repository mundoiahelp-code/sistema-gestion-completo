...
const modelGroups: { [key: string]: string[] } = {
  ...
  'iPhone 13': allModels.filter(m => m.includes('13')),
  'iPhone 12': allModels.filter(m => m.includes('12')),
  'iPhone 11': allModels.filter(m => m.includes('11')),
  'iPhone X': allModels.filter(m => m.includes('X')),
  'iPhone SE': allModels.filter(m => m.includes('SE')),
  'iPhone 8': allModels.filter(m => m.includes('8')),
  'iPhone 7': allModels.filter(m => m.includes('7')),
};
