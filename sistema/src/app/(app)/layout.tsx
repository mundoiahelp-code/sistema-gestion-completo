...
// La autenticación se maneja en middleware.ts a nivel servidor
// Si llegás acá, ya estás autenticado

export default function AppLayout({ children }: { children: React.ReactNode }) {
  // Scanner IMEI global
  useImeiScanner({ enabled: true });
  ...
  useEffect(() => {
    const loadData = async () => {
      // Obtener info de usuario del localStorage
      ...
      if (userData) {
        try {
          ...
          // Si es ADMIN, obtener info del tenant desde el servidor
  ...
  // Si la suscripción está vencida, mostrar pantalla de bloqueo
