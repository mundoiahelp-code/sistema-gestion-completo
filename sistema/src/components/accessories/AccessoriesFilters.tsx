...
// Categorías de accesorios Apple
export const ACCESSORY_CATEGORIES = {
  'Fundas y Protección': [
    'Funda de silicona iPhone',
    'Funda transparente iPhone',
    'Funda MagSafe iPhone',
    'Funda de cuero iPhone',
    'Protector de pantalla iPhone',
    'Vidrio templado iPhone',
  ],
  'Carga y Energía': [
    'Cargador USB-C 20W',
    'Cargador USB-C 35W',
...
// Lista plana de todos los tipos
export const ALL_ACCESSORY_TYPES = Object.values(ACCESSORY_CATEGORIES).flat();
...
export default function AccessoriesFilters({ onFilterChange, currentFilters }: Props) {
  ...
  useEffect(() => {
    ...
    const handleUpdate = () => setVisibleCategories(getVisibleCategories());
  ...
  const availableTypes = filters.category && filters.category !== 'all'
    ? getVisibleTypes(filters.category)
    : getVisibleAllTypes();
