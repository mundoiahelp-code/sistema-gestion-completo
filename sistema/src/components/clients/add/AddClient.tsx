    ...
    <div className='grid-cols-3 gap-2 grid'>
      <Card className='lg:col-span-2 col-span-3'>
        <CardHeader className='font-light text-xl'>
          <CardTitle>{t('addClient.newClient')}</CardTitle>
          <CardDescription>{t('addClient.requiredField')}</CardDescription>
        </CardHeader>
        <CardContent>
          <form
          ...
          >
            ...
            <div className='col-span-2 lg:col-span-1'>
              <div className='col-span-2 lg:col-span-1'>
                <Label>{t('addClient.zone')} *</Label>
                <Input {...zone} />
              </div>
            </div>
            <div className='col-span-2 lg:col-span-1'>
              <div className='col-span-2 lg:col-span-1'>
                <Label>{t('addClient.page')}</Label>
            ...
            <div className='col-span-2 lg:col-span-1'>
              <div className='col-span-2 lg:col-span-1'>
                ...
                <Input {...email} placeholder='domain@email.com' />
              </div>
            </div>
            <div className='col-span-2 lg:col-span-1'>
              <div className='col-span-2 lg:col-span-1'>
        ...
        <CardFooter className='border-t px-0 py-3 mt-3'>
          <Button onClick={handleAddClient} disabled={loading || isDisabled}>
            {loading ? (
