        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Al acceder y utilizar MundoIAple ("el Servicio"), usted acepta estar sujeto a estos Términos y Condiciones. 
              Si no está de acuerdo con alguna parte de estos términos, no debe utilizar nuestro servicio.
            </p>
            <p className="text-gray-700 leading-relaxed">
              MundoIAple es una plataforma de gestión empresarial con inteligencia artificial que incluye funcionalidades 
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Todo el contenido, diseño, código, marcas y materiales del Servicio son propiedad de MundoIAple 
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              MundoIAple no reclamará derechos sobre sus datos comerciales.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              El Servicio se proporciona "tal cual" y "según disponibilidad". MundoIAple no garantiza:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              MundoIAple no será responsable por daños indirectos, incidentales o consecuentes 
          ...
          <section className="mb-12">
            ...
            <ul className="list-none space-y-2 text-gray-700">
              <li><strong>Email:</strong> sistema@mundoaple.com</li>
              <li><strong>WhatsApp:</strong> +54 11 4422-4497</li>
              <li><strong>Sitio web:</strong> www.mundoaple.store</li>
            </ul>
          </section>
        </div>
