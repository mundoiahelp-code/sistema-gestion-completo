...
export default function LandingPage() {
  ...
  const handleFreeTrial = async () => {
    ...
    // Cerrar modal y redirigir directamente (SIN enviar email todavía)
    setShowModal(false);
    toast.success('¡Continuá con tu registro!');
    
    setTimeout(() => {
      window.location.href = `${APP_URL}/activar-cuenta?name=${encodeURIComponent(formData.name)}&email=${encodeURIComponent(formData.email)}`;
    }, 500);
  };
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/60 backdrop-blur-2xl border-b border-white/[0.08]">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
          >
            <img src="/screenshots/logo.png" alt="MundoIAple" className="h-10 w-auto" />
            <span className="text-lg font-semibold text-white hidden sm:block">MundoIAple</span>
          </motion.button>
      ...
      <footer className="py-12 px-6 border-t border-white/[0.08] bg-[#0a0a0a]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2">
              <img src="/screenshots/logo.png" alt="MundoIAple" className="h-10 w-auto" />
              <span className="font-semibold text-white">MundoIAple</span>
            </div>
            <div className="flex items-center gap-6">
          ...
          <div className="mt-8 pt-8 border-t border-white/[0.08] text-center">
            <p className="text-sm text-gray-500">© 2023 MundoIAple. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
            ...
            <div className="bg-gradient-to-b from-[#18181b] to-[#0f0f12] rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl shadow-black/50 border border-white/[0.08]">
              ...
              <div className="relative p-6 md:p-8 text-center">
                ...
                <div className="space-y-2 md:space-y-3">
                  ...
                  <a 
                    href="mailto:sistema@mundoaple.com" 
                  ...
                  >
                    ...
                    <div className="text-left flex-1">
                      ...
                      <p className="text-blue-400 text-xs md:text-sm">sistema@mundoaple.com</p>
                    </div>
                    <ArrowRight className="w-4 h-4 md:w-5 md:h-5 text-white/40 group-hover:text-white group-hover:translate-x-1 transition-all" />
                  </a>
                </div>
            ...
            <div className="bg-gradient-to-b from-[#18181b] to-[#0f0f12] rounded-3xl overflow-hidden shadow-2xl shadow-black/50 border border-white/[0.08]">
              ...
              <div className="relative p-8 text-center">
                ...
                <p className="text-white/30 text-xs mt-6">
                  ¿Problemas? Contactanos a sistema@mundoaple.com
                </p>
              </div>
            </div>
          </motion.div>
      ...
      {showLoadingScreen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-white">
          ...
          <div className="absolute top-8 left-8 flex items-center gap-3">
            <img src="/screenshots/logo-dark.png" alt="MundoIAple" className="h-10 w-auto" />
            <span className="text-xl font-semibold text-gray-900">MundoIAple</span>
          </div>
